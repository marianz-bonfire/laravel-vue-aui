    ...
    export default {
        ...
        methods: {
            addRow(data) {
                ...
                this.dialog.message = this.$t('success.new_value_successfully_added', { value: this.$t('label.department') })
                this.dialog.ok = {
                    function: () => {
                        this.dialog.visible = false;
                    }
            ...
            updateRow(data) {
                ...
                this.dialog.visible = true;
                this.dialog.status = 'success';
                this.dialog.message = this.$t('success.value_successfully_updated', { value: this.$t('label.department') })
                this.dialog.ok = {
                    function: () => {
                        this.dialog.visible = false;
                    }
            ...
            deleteRow(data) {
                ...
                this.dialog.ok = {
                    function: () => {
                        ...
                        this.dialog.status = 'success';
                        this.dialog.message = this.$t('success.value_successfully_deleted', { value: this.$t('label.department') });
                        this.dialog.ok = {
                            function: () => {
                                this.dialog.visible = false;
                            }
